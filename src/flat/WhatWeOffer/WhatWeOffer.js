    ...
    >
      ...
      <div className="what-we-offer-content-container">
        <div className="offer-selector">
          <div className="offer-selector-button" onClick={() => setIndex(0)} role="tab">For you</div>
          <div className="offer-selector-button" onClick={() => setIndex(1)} role="tab">For mentors</div>
        </div>
